   ...
   // iterate each store field
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var tag_plugins = function () {
          var tags = {};

          for (var y in this.x_state.plugins) {
            var x = this.x_state.plugins[y];
        ...
        var add_plugins2story = function add_plugins2story(story_vue) {
          var tags = Object.keys(tag_plugins);
          var resp = story_vue;
            ...
            if (page.tipo == 'componente') {
              ...
              if (_this28.x_state.central_config.storybook == true) {
                ...
                if (vue.script.includes("import Vue from 'vue'") == false) {
                  var _nscript = "<script>\n";
                  _nscript += "import Vue from 'vue';\n";
                  vue_story = vue_story.replace('<script>\n', _nscript);
                } //


                yield _this28.writeFile(svue_path, vue_story); //
