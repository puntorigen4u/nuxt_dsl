  ...
  class local extends base_deploy {
    ...
    deploy() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if ((yield _this._isLocalServerRunning()) == false || _this.context.x_state.central_config.static == true) {
  ...
  class remote extends base_deploy {
    ...
    run() {
      ...
      return _asyncToGenerator(function* () {
        ...
        spinner.start("Launching remote access for port ".concat(_this2.context.x_state.central_config.port));

        try {
          //launch ngrok in new terminal
          yield sleep(1000);
          yield _this2.launchTerminal('npx', ['localtunnel', '--port', _this2.context.x_state.central_config.port, '--subdomain', _this2.context.x_state.central_config.apptitle.toLowerCase()], _this2.context.x_state.dirs.app);
   ...
   // iterate each store field
        ...
        if (_this17.x_state.config_node.axios) {
          ...
          if (deploy.includes('eb:') || deploy.includes('true')) {
            ...
            if (_this17.x_state.config_node.axios.local) {
              ...
              if (_this17.x_state.config_node.axios.local.includes('127.0.0.1')) _this17.x_state.config_node.axios.https = false;
            }
    ...
    createPackageJSON() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this18.x_state.central_config[':hostname']) data.scripts.dev += " --hostname '".concat(_this18.x_state.central_config[':hostname'], "'");
        if (_this18.x_state.central_config.deploy == 'remote' && !_this18.x_state.central_config[':hostname']) data.scripts.dev += " --hostname '0.0.0.0'";
    ...
    createVSCodeHelpers() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var path = require('path'); // creates /tsconfig.json file for Vetur and IntelliSense
        ...
        var target = path.join(_this19.x_state.dirs.app, "tsconfig.json");
        var content = JSON.stringify(data);
