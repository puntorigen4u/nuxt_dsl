  ...
  class s3 extends base_deploy {
    ...
    run() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this4.context.debug('AWS S3 deploy'); //create bucket policy
    ...
    post() {
      ...
      return _asyncToGenerator(function* () {
        //restores aws credentials if modified by onPrepare after deployment
        if (!_this5.context.x_state.central_config.componente && _this5.context.x_state.central_config.deploy && _this5.context.x_state.central_config.deploy.indexOf('s3:') != -1 && _this5.context.x_state.config_node.aws) {
    ...
    pre() {
      ...
      return _asyncToGenerator(function* () {
        if (!_this6.context.x_state.central_config.componente && _this6.context.x_state.central_config.deploy && _this6.context.x_state.central_config.deploy.indexOf('s3:') != -1) {
