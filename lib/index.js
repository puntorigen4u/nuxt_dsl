    ...
    createGitIgnore() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this9.x_state.central_config.componente) {
          ...
          var git = "# Mac System files\n.DS_Store\n.DS_Store?\n_MACOSX/\nThumbs.db\n# VUE files\n# Concepto files\ndsl_cache/\ndsl_cache.ini\nvue.dsl\ntmp.ini\n".concat(_this9.x_state.dirs.compile_folder, "/node_modules/");
          ...
          var _git = "# Mac System files\n.DS_Store\n.DS_Store?\n_MACOSX/\nThumbs.db\n# VUE files\n.nuxt/\n# Concepto files\ndsl_cache/\ndsl_cache.ini\ntmp.ini\nvue.dsl\nstats.txt\nstats.json\nstore/\n".concat(_this9.x_state.dirs.compile_folder, "/node_modules/\n").concat(_this9.x_state.dirs.compile_folder, "/secrets/");
          ...
          if (node_key.includes(':') == false) {
            if ('aurora,vpc,aws'.split(',').includes(node_key) == false) {
              if (_this20.x_state.secrets[node_key] === undefined && typeof _this20.x_state.config_node[node_key] === 'object') {
                config.env[node_key.toLowerCase()] = _objectSpread2({}, _this20.x_state.config_node[node_key]);
              }
            }
          }
