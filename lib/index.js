        ...
        'def_consultar_web': {
          ...
          func: function () {
            var _func112 = _asyncToGenerator(function* (node, state) {
              ...
              for (var _x230 in attrs) {
                if (_x230.length > 2 && _x230.substr(0, 3) == 'x-:') {
                  tmp.config.headers[_x230.right(_x230.length - 3)] = attrs[_x230];
                  delete attrs[_x230];
                } else if (_x230.length > 2 && _x230.substr(0, 2) == 'x-') {
                  tmp.config.headers[_x230] = attrs[_x230];
                  delete attrs[_x230];
                }
              }
