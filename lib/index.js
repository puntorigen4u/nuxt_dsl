  ...
  class eb extends base_deploy {
    ...
    post() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this4.context.x_state.central_config.componente && _this4.context.x_state.central_config.deploy && _this4.context.x_state.central_config.deploy.indexOf('eb:') != -1 && _this4.context.x_state.config_node.aws) {
    ...
    pre() {
      ...
      return _asyncToGenerator(function* () {
        if (!_this5.context.x_state.central_config.componente && _this5.context.x_state.central_config.deploy && _this5.context.x_state.central_config.deploy.indexOf('eb:') != -1) {
  ...
  class s3 extends base_deploy {
    ...
    modifyNuxtConfig(config) {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this.context.x_state.central_config.static = true; //force static mode
    ...
    deploy() {
      ...
      return _asyncToGenerator(function* () {
        ...
        build.deploy_aws_s3 = yield _this2.run(); //test if results.length>0 (meaning there was an error)
    ...
    run() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var bucket = _this3.context.x_state.central_config.deploy.replaceAll('s3:', '').trim();

        if (_this3.x_state.central_config.dominio) {
          bucket = _this3.x_state.central_config.dominio.trim();
        }

        var region = 'us-east-1';
        if (_this3.context.x_state.config_node.aws.region) region = _this3.context.x_state.config_node.aws.region;
        var dist_folder = path.join(_this3.context.x_state.dirs.compile_folder, 'dist/'); //AWS S3 deploy        

        _this3.context.debug('AWS S3 deploy'); //create bucket policy
        ...
        var policyFile = path.join(_this3.context.x_state.dirs.base, 'policy.json');

        try {
          yield _this3.context.writeFile(policyFile, JSON.stringify(policy));
        ...
        try {
          results.create_bucket = yield spawn('aws', ['s3api', 'create-bucket', '--bucket', bucket, '--region', region, '--create-bucket-configuration', 'LocationConstraint=' + region, '--profile', 'equivalent'], {
            cwd: _this3.context.x_state.dirs.base
          });
        ...
        try {
          results.adding_policy = yield spawn('aws', ['s3api', 'put-bucket-policy', '--bucket', bucket, '--policy', 'file://' + policyFile, '--profile', 'equivalent'], {
            cwd: _this3.context.x_state.dirs.base
          });
        ...
        try {
          results.website_upload = yield spawn('aws', ['s3', 'sync', dist_folder, 's3://' + bucket + '/', '--profile', 'equivalent'], {
            cwd: _this3.context.x_state.dirs.base
          });
        ...
        try {
          results.set_as_website = yield spawn('aws', ['s3', 'sync', dist_folder, 's3://' + bucket + '/', '--index-document', 'index.html', '--error-document', '200.html', '--profile', 'equivalent'], {
            cwd: _this3.context.x_state.dirs.base
          });
    ...
    post() {
      ...
      return _asyncToGenerator(function* () {
        //restores aws credentials if modified by onPrepare after deployment
        if (!_this4.context.x_state.central_config.componente && _this4.context.x_state.central_config.deploy && _this4.context.x_state.central_config.deploy.indexOf('s3:') != -1 && _this4.context.x_state.config_node.aws) {
    ...
    pre() {
      ...
      return _asyncToGenerator(function* () {
        if (!_this5.context.x_state.central_config.componente && _this5.context.x_state.central_config.deploy && _this5.context.x_state.central_config.deploy.indexOf('s3:') != -1) {
          ...
          if (_this5.context.x_state.config_node.aws) {
            ...
            if (_this5.context.x_state.config_node.aws.region) {
              _this5.context.x_console.outT({
                message: "config:aws:region ->".concat(_this5.context.x_state.config_node.aws.region)
              });
            } // transform config_node.aws keys into ini
            ...
            if (_this5.context.x_state.config_node.aws.region) {
              to_aws.region = _this5.context.x_state.config_node.aws.region;
            }
            ...
            if (parsed.default.aws_access_key_id) _this5.context.x_state.config_node.aws.access = parsed.default.aws_access_key_id;
            if (parsed.default.aws_secret_access_key) _this5.context.x_state.config_node.aws.secret = parsed.default.aws_secret_access_key;
            if (parsed.default.region) _this5.context.x_state.config_node.aws.region = parsed.default.region;
          }
        }
      })();
    }
  ...
  class vue_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this.x_state.central_config = yield _this._readCentralConfig(); //if requested change deploy target

        if (_this.x_config.deploy && _this.x_config.deploy.trim() != '') {
          _this.x_console.outT({
            message: "(as requested) force changing deploy target to: ".concat(_this.x_config.deploy.trim()),
            color: "brightYellow"
          });

          _this.x_state.central_config.deploy = _this.x_config.deploy;
        }

        var compile_folder = _this.x_state.central_config.apptitle;

        if (_this.x_config.folder && _this.x_config.folder.trim() != '') {
          compile_folder = _this.x_config.folder.trim();
        }

        if (_this.x_config.aws_region && _this.x_config.aws_region.trim() != '') {
          if (!_this.x_state.config_node.aws) _this.x_state.config_node.aws = {};
          _this.x_state.config_node.aws.region = _this.x_config.aws_region.trim();
    ...
    onPrepare() {
      ...
      return _asyncToGenerator(function* () {
        if (Object.keys(_this4.x_commands).length > 0) _this4.x_console.outT({
          message: "".concat(Object.keys(_this4.x_commands).length, " x_commands loaded!"),
          color: "green"
        });
        ...
        if (deploy) {
          ...
          if (deploy.includes('eb:')) {
            ...
            _this4.deploy_module = new remote({
              context: _this4
            });
          } else if (deploy == 'ghpages') {
            _this4.deploy_module = new ghpages({
              context: _this4
            });
          } else ;
        }
    ...
    generalConfigSetup() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this6.debug('Setting general configuration steps');

        _this6.debug('Defining nuxt.config.js : initializing'); // default modules


        _this6.debug('Defining nuxt.config.js : default modules');

        _this6.x_state.nuxt_config.modules['@nuxtjs/axios'] = {}; //google analytics

        if (_this6.x_state.config_node['google:analytics']) {
          _this6.debug('Defining nuxt.config.js : Google Analytics');

          _this6.x_state.nuxt_config.build_modules['@nuxtjs/google-gtag'] = {
            'id': _this6.x_state.config_node['google:analytics'].id,
            'debug': true,
            'disableAutoPageTrack': true
          };
          if (_this6.x_state.config_node['google:analytics'].local) _this6.x_state.nuxt_config.build_modules['@nuxtjs/google-gtag'].debug = _this6.x_state.config_node['google:analytics'].local;

          if (_this6.x_state.config_node['google:analytics'].auto && _this6.x_state.config_node['google:analytics'].auto == true) {
            delete _this6.x_state.nuxt_config.build_modules['@nuxtjs/google-gtag']['disableAutoPageTrack'];
          }
        } //medianet


        if (_this6.x_state.config_node['ads:medianet'] && _this6.x_state.config_node['ads:medianet']['cid']) {
          _this6.debug('Defining nuxt.config.js : MediaNet');

          _this6.x_state.nuxt_config.head_script['z_ads_medianet_a'] = {
            'innerHTML': 'window._mNHandle = window._mNHandle || {}; window._mNHandle.queue = window._mNHandle.queue || []; medianet_versionId = "3121199";',
            'type': 'text/javascript'
          };
          _this6.x_state.nuxt_config.head_script['z_ads_medianet_b'] = {
            'src': "https://contextual.media.net/dmedianet.js?cid=".concat(_this6.x_state.config_node['ads:medianet'][cid]),
            'async': true
          };
          _this6.x_state.plugins['vue-script2'] = {
            global: true,
            npm: {
              'vue-script2': '*'
            }
        ...
        if (_this6.x_state.config_node['google:adsense']) {
          _this6.debug('Defining nuxt.config.js : Google Adsense');

          if (_this6.x_state.config_node['google:adsense'].auto && _this6.x_state.config_node['google:adsense'].client) {
            _this6.x_state.nuxt_config.head_script['google_adsense'] = {
              'src': 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js',
              'data-ad-client': _this6.x_state.config_node['google:adsense'].client,
              'async': true
            };
            _this6.x_state.plugins['adsense'] = {
              global: true,
              npm: {
                'vue-google-adsense': '*',
                'vue-script2': '*'
              ...
              mode: 'client',
              customcode: "\n\t\t\t\t\timport Vue from \"vue\";\n\t\t\t\t\timport Ads from \"vue-google-adsense\";\n\n\t\t\t\t\tVue.use(require('vue-script2'));\n\t\t\t\t\tVue.use(Ads.AutoAdsense, { adClient: '".concat(_this6.x_state.config_node['google:adsense']['client'], "'});")
            };
          } else {
            _this6.x_state.plugins['adsense'] = {
              global: true,
        ...
        if (_this6.x_state.config_node['nuxt:icon']) {
          _this6.debug('Defining nuxt.config.js : module nuxtjs/pwa (nuxt:icon)');

          _this6.x_state.nuxt_config.modules['@nuxtjs/pwa'] = {};
        } //idiomas i18n


        if (_this6.x_state.central_config['idiomas'].indexOf(',') != -1) {
          _this6.debug('Defining nuxt.config.js : module nuxt/i18n (idiomas)');

          _this6.x_state.npm['nuxt-i18n'] = '*';
          _this6.x_state.npm['fs'] = '*';
          _this6.x_state.nuxt_config.modules['nuxt-i18n'] = {
            'defaultLocale': _this6.x_state.central_config['idiomas'].split(',')[0],
            'vueI18n': {
              'fallbackLocale': _this6.x_state.central_config['idiomas'].split(',')[0]
            },
          ...
          _this6.x_state.central_config['idiomas'].split(',').map(function (lang) {
            if (lang == 'es') {
        ...
        if (_this6.x_state.stores_types['local'] && Object.keys(_this6.x_state.stores_types['local']) != '') {
          _this6.debug('Defining nuxt.config.js : module nuxt-vuex-localstorage (store:local)');

          _this6.x_state.nuxt_config.modules['nuxt-vuex-localstorage'] = {
            mode: 'debug',
            'localStorage': Object.keys(_this6.x_state.stores_types['local'])
          };
        } //session storage


        if (_this6.x_state.stores_types['session'] && Object.keys(_this6.x_state.stores_types['session']) != '') {
          _this6.debug('Defining nuxt.config.js : module nuxt-vuex-localstorage (store:session)');

          var prev = {}; // if vuex-localstorage was defined before, recover keys and just replace with news, without deleting previous

          if (_this6.x_state.nuxt_config.modules['nuxt-vuex-localstorage']) prev = _this6.x_state.nuxt_config.modules['nuxt-vuex-localstorage'];
          _this6.x_state.nuxt_config.modules['nuxt-vuex-localstorage'] = _objectSpread2(_objectSpread2({}, prev), {
            mode: 'debug',
            'sessionStorage': Object.keys(_this6.x_state.stores_types['session'])
          });
        } //proxies
        ...
        var has_proxies = false,
            proxies = {};
        var self = _this6;
        Object.keys(_this6.x_state.central_config).map(function (key) {
        ...
        if (has_proxies) {
          _this6.debug('Defining nuxt.config.js : module nuxtjs/proxy (central:proxy)');

          _this6.x_state.npm['@nuxtjs/proxy'] = '*';
          _this6.x_state.nuxt_config.modules['@nuxtjs/proxy'] = {
            'proxy': proxies
          };
        } //end
    ...
    createGitIgnore() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this7.x_state.central_config.componente) {
          _this7.debug({
            message: 'writing dsl /.gitignore file'
          });

          var git = "# Mac System files\n.DS_Store\n.DS_Store?\n_MACOSX/\nThumbs.db\n# VUE files\n# Concepto files\ndsl_cache/\ndsl_cache.ini\nvue.dsl\ntmp.ini\n".concat(_this7.x_state.dirs.compile_folder, "/node_modules/");
          yield fs.writeFile("".concat(_this7.x_state.dirs.base, ".gitignore"), git, 'utf-8'); //.gitignore

          _this7.x_console.out({
            message: 'writing component .gitignore file'
          });

          git = "# Mac System files\n.DS_Store\n.DS_Store?\n_MACOSX/\nThumbs.db\n# NPM files\npackage-lock.json\nnode_modules/\n# AWS EB files\n.elasticbeanstalk/*\n!.elasticbeanstalk/*.cfg.yml\n!.elasticbeanstalk/*.global.yml";
          yield fs.writeFile("".concat(_this7.x_state.dirs.app, "/.gitignore"), git, 'utf-8'); //app/.gitignore
        } else {
          _this7.x_console.out({
            message: 'writing /.gitignore file'
          });

          var _git = "# Mac System files\n.DS_Store\n.DS_Store?\n_MACOSX/\nThumbs.db\n# VUE files\n.nuxt/\n# Concepto files\ndsl_cache/\ndsl_cache.ini\ntmp.ini\nvue.dsl\nstats.txt\nstats.json\nstore/\n".concat(_this7.x_state.dirs.compile_folder, "/node_modules/\n").concat(_this7.x_state.dirs.compile_folder, "/secrets/");

          yield fs.writeFile("".concat(_this7.x_state.dirs.base, ".gitignore"), _git, 'utf-8'); //.gitignore
        }
      })();
    } //process .omit file 
    ...
    processOmitFile(thefile) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (thefile.file == 'internal_stores.omit') {
          _this8.debug('processing internal_stores.omit');
        ...
        if (thefile.file == 'internal_middleware.omit') {
          _this8.debug('processing internal_middleware.omit');
        ...
        if (thefile.file == 'server.omit') {
          _this8.debug('processing server.omit');
    ...
    getBasicVue(thefile) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var page = _this9.x_state.pages[thefile.title];

        if (page) {
          // declare middlewares (proxies)
          if (page.proxies.indexOf(',') != -1) {
            _this9.debug('- declare middlewares');
          ...
          if (page.components != '') {
            _this9.debug('- declare components');
          ...
          if (page.directives != '') {
            _this9.debug('- declare directives');
          ...
          if (page.tipo == 'componente' && page.params != '') {
            _this9.debug('- declare componente:props');
          ...
          if (page.xtitle || page.meta.length > 0) {
            _this9.debug('- declare head() meta data');
            ...
            if (page.xtitle) {
              if (_this9.x_state.central_config.idiomas.indexOf(',') != -1) {
                // i18n title
                var crc32 = "t_".concat(yield _this9.hash(page.xtitle));

                var def_lang = _this9.x_state.central_config.idiomas.indexOf(',')[0].trim().toLowerCase();

                if (!_this9.x_state.strings_i18n[def_lang]) {
                  _this9.x_state.strings_i18n[def_lang] = {};
                }

                _this9.x_state.strings_i18n[def_lang][crc32] = page.xtitle;
          ...
          if (Object.keys(page.variables) != '') {
            _this9.debug('- declare data() variables');
            ...
            vue.script += "data() {\n";
            vue.script += " return ".concat(_this9.jsDump(page.variables), "\n");
            vue.script += "}\n";
          }
        }
    ...
    processInternalTags(vue, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (nodes.length > 0) _this10.debug('post-processing server_asyncdata tag');
        ...
        if (nodes.length > 0) _this10.debug('post-processing vue_mounted tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        if (nodes.length > 0) _this10.debug('post-processing vue_computed tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        if (nodes.length > 0) _this10.debug('post-processing vue_async_computed tag');
        if (nodes.length > 0 && vue.first) vue.script += ',\n';
        vue.first = true;
        ...
        for (var x of [1, 2, 3, 4, 5]) {
          ...
          if (nodes.length > 0) {
            _this10.debug("post-processing vue_if tag ".concat(x, " (len:").concat(nodes.length, ")"));
          ...
          yield _this10.setImmediatePromise(); //@improved
        } //
        ...
        for (var _x2 of [1, 2, 3, 4, 5]) {
          ...
          if (nodes.length > 0) {
            _this10.debug("post-processing vue_for tag ".concat(_x2, " (len:").concat(nodes.length, ")"));
            nodes.map(function (elem) {
              var cur = $(elem);
        ...
        if (common_methods.length > 0 || on_events.length > 0) {
          _this10.debug('post-processing methods (common, timer, and v-on element events methods)');

          if (vue.first) vue.script += ',\n';
          vue.first = true;
          var methods = [],
              _self2 = _this10; // event_methods
    ...
    processLangPo(vue, page) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this11.x_state.central_config.idiomas.indexOf(',') != -1) {
          _this11.debug('process /lang/ po/mo files');

          var path = require('path'),
              fs = require('fs').promises; // .check and create directs if needed


          var lang_path = path.join(_this11.x_state.dirs.base, '/lang/');
          ...
          _this11.x_state.central_config.idiomas.split(',')[0]; // .read other po/mo files from lang dir and convert to .js


          for (var idioma in _this11.x_state.central_config.idiomas.split(',')) {
          } //
    ...
    createVueXStores() {
      ...
      return _asyncToGenerator(function* () {
        if (Object.keys(_this12.x_state.stores).length > 0) {
          ...
          for (var store_name in _this12.x_state.stores) {
            var store = _this12.x_state.stores[store_name];
            var file = path.join(_this12.x_state.dirs.store, "".concat(store_name, ".js"));
            var def_types = {
              'integer': 0,
              'int': 0,
              'float': 0.0,
   ...
   // iterate each store field
            ...
            if (store_name in _this12.x_state.stores_types['expires']) {
              obj['expire'] = parseInt(_this12.x_state.stores_types['expires'][store_name]);
            } // versions?


            if (store_name in _this12.x_state.stores_types['versions']) {
              obj['version'] = parseInt(_this12.x_state.stores_types['versions'][store_name]);
            } // write content


            delete obj[':mutations'];
            var content = "export const state = () => (".concat(_this12.jsDump(obj), ")\n"); // :mutations?
    ...
    createServerMethods() {
      ...
      return _asyncToGenerator(function* () {
        if (Object.keys(_this13.x_state.functions).length > 0) {
          ...
          var file = path.join(_this13.x_state.dirs.server, "api.js");
          ...
          for (var x in _this13.x_state.functions) {
            for (var imp in _this13.x_state.functions[x]) {
              imps[imp] = _this13.x_state.functions[x][imp];
          ...
          for (var func_name in _this13.x_state.functions) {
            var func = _this13.x_state.functions[func_name];
            var func_return = "";
    ...
    createMiddlewares() {
      ...
      return _asyncToGenerator(function* () {
        if (Object.keys(_this14.x_state.proxies).length > 0) {
          ...
          for (var proxy_name in _this14.x_state.proxies) {
            var proxy = _this14.x_state.proxies[proxy_name];
            var file = path.join(_this14.x_state.dirs.middleware, "".concat(proxy_name, ".js")); //add imports
            ...
            for (var page_name in _this14.x_state.pages) {
              if (page_name != '') {
                var page = _this14.x_state.pages[page_name];
              ...
              yield _this14.setImmediatePromise(); //@improved
            } //write file
    ...
    prepareServerFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var index_file = path.join(_this15.x_state.dirs.app, "index.js");

        _this15.writeFile(index_file, index); // allowed binary mimetypes
        ...
        if (_this15.x_state.config_node['nuxt:mimetypes']) {
          var user_mimes = [];

          for (var usermime in _this15.x_state.config_node['nuxt:mimetypes']) {
        ...
        var mime = "// binaryMimeTypes.js\n        module.exports = ".concat(_this15.jsDump(allowed), ";");
        var mime_file = path.join(_this15.x_state.dirs.app, "binaryMimeTypes.js");

        _this15.writeFile(mime_file, mime);
      })();
    }
    ...
    installRequiredPlugins() {
      ...
      return _asyncToGenerator(function* () {
        _this16.x_state.plugins['vuetify'] = {
          global: true,
          npm: {
            'node-sass': '*'
          },
        ...
        _this16.x_state.nuxt_config.build_modules['@nuxtjs/vuetify'] = {};
        _this16.x_state.plugins['aos'] = {
          global: true,
          npm: {
            aos: '*'
          },
    ...
    createNuxtPlugins() {
      ...
      return _asyncToGenerator(function* () {
        ...
        for (var plugin_key in _this17.x_state.plugins) {
          var plugin = _this17.x_state.plugins[plugin_key];

          if (typeof plugin === 'object') {
            // copy x_state_plugins npm's into npm global imports (for future package.json)
            if (plugin.npm) _this17.x_state.npm = _objectSpread2(_objectSpread2({}, _this17.x_state.npm), plugin.npm);
            if (plugin.dev_npm) _this17.x_state.dev_npm = _objectSpread2(_objectSpread2({}, _this17.x_state.dev_npm), plugin.dev_npm);
            ...
            if (plugin.styles) {
              for (var style_key in plugin.styles) {
                ...
                if (style.file.includes('/') == false) {
                  var target = path.join(_this17.x_state.dirs.css, style.file);
                  yield _this17.writeFile(target, style.content);
                  resp.css_files.push({
            ...
            if (plugin.config) {
              if (typeof plugin.config === 'object') {
                _code += "const config = ".concat(_this17.jsDump(plugin.config), ";\n                        Vue.use(").concat(import_as, ",config);");
              } else {
            ...
            if (import_as != 'vuetify') {
              ...
              var _target2 = path.join(_this17.x_state.dirs.plugins, "".concat(import_as, ".js"));

              yield _this17.writeFile(_target2, _code);
            }
          } else {
            //simple plugin
            _this17.x_state.npm[plugin_key] = plugin;
            ...
            if (_import_as != 'vuetify') {
              ...
              var _target3 = path.join(_this17.x_state.dirs.plugins, "".concat(_import_as, ".js"));

              yield _this17.writeFile(_target3, code);
            }
          }
        }
    ...
    createNuxtConfig() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var target = path.join(_this18.x_state.dirs.app, "nuxt.config.js");
        _this18.x_state.central_config[':mode'] == 'spa' ? true : false;
        if (_this18.x_state.central_config[':ssr']) _this18.x_state.central_config[':ssr'];
        var target_val = _this18.x_state.central_config.static == true ? 'static' : 'server';
        _this18.x_state.central_config.deploy + '';
        var config = {
          ssr: true,
          ...
          head: {
            title: _this18.x_state.config_node['nuxt:title'] ? _this18.x_state.config_node['nuxt:title'] : _this18.x_state.central_config.apptitle,
            meta: [],
            link: [{
              rel: 'icon',
              type: 'image/x-icon',
        ...
        if (_this18.x_state.central_config.static == true) {
          config.ssr = false;
          config.performance.gzip = false;
        } //add title:meta data


        if (_this18.x_state.config_node['nuxt:meta']) {
          for (var meta_key in _this18.x_state.config_node['nuxt:meta']) {
            if (meta_key.charAt(0) != ':') {
              var test = meta_key.toLowerCase().trim();
              var value = _this18.x_state.config_node['nuxt:meta'][meta_key];
        ...
        if (_this18.x_state.config_node.axios) {
          var ax_config = {
            proxy: _this18.x_state.nuxt_config.modules['@nuxtjs/proxy'] ? true : false
          };
          ax_config = _objectSpread2(_objectSpread2({}, _this18.x_state.config_node.axios), ax_config);
          ...
          if (ax_config.retries) {
            ...
            _this18.x_state.npm['axios-retry'] = '*';
          }
          /*
        ...
        if (_this18.x_state.config_node['vue:config']) {
          config.vue = {
            config: _this18.x_state.config_node['vue:config']
          };
        ...
        if (_this18.x_state.nuxt_config.modules['@nuxtjs/proxy']) {
          config.proxy = _this18.x_state.nuxt_config.modules['@nuxtjs/proxy'];
        } //nuxt env variables
        ...
        for (var node_key in _this18.x_state.config_node) {
          if (node_key.includes(':') == false) {
            if ('aurora,vpc,aws'.split(',').includes(node_key) == false) {
              if (_this18.x_state.secrets[node_key] === undefined && typeof _this18.x_state.config_node[node_key] === 'object') {
                config.env[node_key.toLowerCase()] = _objectSpread2({}, _this18.x_state.config_node[node_key]);
              }
            }
          }
        ...
        if (_this18.x_state.config_node['google:analytics']) {
          if (_this18.x_state.config_node['google:analytics'].local && _this18.x_state.config_node['google:analytics'].local == true) {
            config.debug = true;
          }
        } //nuxt modules


        for (var module_key in _this18.x_state.nuxt_config.modules) {
          var module = _this18.x_state.nuxt_config.modules[module_key];
        ...
        for (var _module_key in _this18.x_state.nuxt_config.build_modules) {
          var _module = _this18.x_state.nuxt_config.build_modules[_module_key];
        ...
        config.plugins = _this18.x_state.nuxt_config.plugins;
        config.css = _this18.x_state.nuxt_config.css; //muxt server methods

        if (_this18.x_state.functions && Object.keys(_this18.x_state.functions).length > 0) config.serverMiddleware = ['~/server/api']; //nuxt build - cfc: 12637
        ...
        if (_this18.x_state.central_config.stage && _this18.x_state.central_config.stage != 'production' && _this18.x_state.central_config.stage != 'prod') {
          config.build.publicPath = "/".concat(_this18.x_state.central_config.stage, "/_nuxt/");
        ...
        if (_this18.deploy_module.modifyNuxtConfig) {
          config = yield _this18.deploy_module.modifyNuxtConfig(config);
        }

        var content = _this18.jsDump(config).replaceAll("'`", "`").replaceAll("`'", "`");

        yield _this18.writeFile(target, "export default ".concat(content)); //this.x_console.outT({ message:'future nuxt.config.js', data:data});
      })();
    }
    ...
    createPackageJSON() {
      ...
      return _asyncToGenerator(function* () {
        var data = {
          name: _this19.x_state.central_config.service_name,
          version: '',
          description: _this19.x_state.central_config[':description'],
          main: 'index.js',
          dependencies: {},
          devDependencies: {},
          scripts: {
        ...
        if (!_this19.x_state.central_config.static) {
        ...
        if (_this19.x_state.central_config.componente) {
          data = {
            name: '',
            version: '',
            description: '',
            main: _this19.x_state.central_config.service_name + '.vue',
            dependencies: {},
            devDependencies: {},
            scripts: {
              test: 'jest',
            ...
            unpkg: "umd/".concat(_this19.x_state.central_config.service_name, ".js"),
            jsdelivr: "umd/".concat(_this19.x_state.central_config.service_name, ".js"),
            keywords: [],
            author: '',
            license: ''
          };
        ...
        if (_this19.x_state.central_config.port != 3000) data.scripts.dev = "nuxt --port ".concat(_this19.x_state.central_config.port);
        if (_this19.x_state.central_config[':hostname']) data.scripts.dev += " --hostname '".concat(_this19.x_state.central_config[':hostname'], "'"); //if (this.x_state.central_config.deploy=='remote' && !this.x_state.central_config[':hostname']) data.scripts.dev += ` --hostname '0.0.0.0'`;

        if (_this19.x_state.central_config[':version']) data.version = _this19.x_state.central_config[':version'];
        if (_this19.x_state.central_config[':author']) data.author = _this19.x_state.central_config[':author'];
        if (_this19.x_state.central_config[':license']) data.license = _this19.x_state.central_config[':license'];

        if (_this19.x_state.central_config[':git']) {
          data.repository = {
            type: 'git',
            url: "git+".concat(_this19.x_state.central_config[':git'], ".git")
          };
          data.bugs = {
            url: "".concat(_this19.x_state.central_config[':git'], "/issues")
          };
          data.homepage = _this19.x_state.central_config[':git'];
        }

        if (_this19.x_state.central_config[':keywords']) data.keywords = _this19.x_state.central_config[':keywords'].split(','); //add dependencies

        for (var pack in _this19.x_state.npm) {
          if (_this19.x_state.npm[pack].includes('http') && _this19.x_state.npm[pack].includes('github.com')) {
            data.dependencies[pack] = "git+".concat(_this19.x_state.npm[pack]);
          } else {
            data.dependencies[pack] = _this19.x_state.npm[pack];
          }
        } //add devDependencies


        for (var _pack in _this19.x_state.dev_npm) {
          if (_this19.x_state.dev_npm[_pack].includes('http') && _this19.x_state.dev_npm[_pack].includes('github.com')) {
            data.devDependencies[_pack] = "git+".concat(_this19.x_state.dev_npm[_pack]);
          } else {
            data.devDependencies[_pack] = _this19.x_state.dev_npm[_pack];
          }
        } //write to disk
        ...
        var target = path.join(_this19.x_state.dirs.app, "package.json");

        if (_this19.deploy_module.modifyPackageJSON) {
          data = yield _this19.deploy_module.modifyPackageJSON(data);
        }

        var content = JSON.stringify(data);
        yield _this19.writeFile(target, content); //this.x_console.outT({ message:'future package.json', data:data});
      })();
    }
    ...
    createVSCodeHelpers() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var target = path.join(_this20.x_state.dirs.app, "jsconfig.json");
        var content = JSON.stringify(data);
        yield _this20.writeFile(target, content);
      })();
    }
    ...
    createServerlessYML() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var deploy = _this21.x_state.central_config.deploy + '';

        if (deploy.includes('eb:') == false && deploy != false && deploy != 'local') {
          data.service = _this21.x_state.central_config.service_name;
          data.custom = {
            prune: {
              automatic: true,
              includeLayers: true,
          ...
          for (var secret in _this21.x_state.secrets) {
            data.custom[secret] = '${file(secrets/' + secret + '.json)}';
          } //domain info


          if (_this21.x_state.central_config.dominio) {
            data.custom.customDomain = {
              domainName: _this21.x_state.central_config.dominio
            };
            if (_this21.x_state.central_config.basepath) data.custom.customDomain.basePath = _this21.x_state.central_config.basepath;
            if (_this21.x_state.central_config.stage) data.custom.customDomain.stage = _this21.x_state.central_config.stage;
          ...
          data.provider = {
            name: 'aws',
            runtime: 'nodejs8.10',
            timeout: _this21.x_state.central_config.timeout
          };
          if (_this21.x_state.central_config.stage) data.provider.stage = _this21.x_state.central_config.stage; //env keys

          if (Object.keys(_this21.x_state.config_node) != '') {
            data.provider.enviroment = {};
            if (_this21.x_state.central_config.stage) data.provider.enviroment.STAGE = _this21.x_state.central_config.stage;

            if (_this21.x_state.config_node.vpc) {
              data.provider.vpc = {
                securityGroupIds: [_this21.x_state.config_node.vpc.security_group_id],
                subnetIDs: []
              };

              if (_this21.x_state.secrets.vpc) {
                data.provider.vpc.securityGroupIds = ['${self:custom.vpc.SECURITY_GROUP_ID}'];
              }

              if (_this21.x_state.config_node.vpc.subnet1_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET1_ID}');
              if (_this21.x_state.config_node.vpc.subnet2_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET2_ID}');
              if (_this21.x_state.config_node.vpc.subnet3_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET3_ID}');
              if (_this21.x_state.config_node.vpc.subnet4_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET4_ID}');
              if (_this21.x_state.config_node.vpc.subnet5_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET5_ID}');
              if (_this21.x_state.config_node.vpc.subnet6_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET6_ID}');
              if (_this21.x_state.config_node.vpc.subnet7_id) data.provider.vpc.subnetIDs.push('${self:custom.vpc.SUBNET7_ID}');
            }
          ...
          if (_this21.x_state.central_config['keep-warm']) {
          ...
          if (_this21.x_state.central_config.dominio) data.plugins.push('serverless-domain-manager'); //write yaml to disk

          var content = yaml.stringify(data);

          var path = require('path');

          var target = path.join(_this21.x_state.dirs.app, "serverless.yml");
          yield _this21.writeFile(target, content); //debug
    ...
    onEnd() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this22.errors_found) {
          //only deploy if no errors were found
          if (!(yield _this22.deploy_module.deploy()) && !_this22.x_state.central_config.componente) {
            _this22.x_console.outT({
              message: 'Something went wrong deploying, check the console, fix it and run again.',
              color: 'red'
            });
          }
          yield _this22.deploy_module.post();
        }
      })();
    }
      ...
      return _asyncToGenerator(function* () {
        ...
        if (ext == 'js') {
          try {
            ...
            _this23.debug("error: could not format the JS file; trying js-beautify");
          ...
          try {
            ...
            _this23.debug("warning: could not format the vue file; trying vue-beautify", ee);
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        yield _this24.generalConfigSetup();
        yield _this24.createGitIgnore();

        _this24.debug('processing nodes');
        ...
        for (var thefile_num in processedNodes) {
          ...
          if (thefile.file.split('.').slice(-1) == 'omit') {
            yield _this24.processOmitFile(thefile); //process special non 'files'
          } else {
            _this24.debug('processing node ' + thefile.title);

            var vue = yield _this24.getBasicVue(thefile);
            var page = _this24.x_state.pages[thefile.title]; // @TODO check the vue.template replacements (8-mar-21)
            // declare server:asyncData

            _this24.debug('post-processing internal custom tags');

            vue = yield _this24.processInternalTags(vue, page); // closure ...
            // **** **** start script wrap **** **** **** **** 
            ...
            vue = _this24.processMixins(vue, page); // process Styles

            vue = _this24.processStyles(vue, page); // removes refx attributes

            vue = _this24.removeRefx(vue); // fix {vuepath:} placeholders

            vue = _this24.fixVuePaths(vue, page); // process lang files (po)

            vue = yield _this24.processLangPo(vue, page); // ********************************** //
            ...
            var w_path = path.join(_this24.x_state.dirs.pages, thefile.file);

            if (page.tipo == 'componente') {
              _this24.x_console.outT({
                message: "writing vue 'component' file ".concat(thefile.file),
                color: 'cyan'
              });

              w_path = path.join(_this24.x_state.dirs.components, thefile.file.replace('.vue', '')); //create individual 'component' directory
              ...
              if (page.for_export) {
                ...
                yield _this24.writeFile(dsl_file, page.for_export);
              }
              ...
              w_path = path.join(_this24.x_state.dirs.layouts, thefile.file);
            } else {
              _this24.x_console.outT({
            ...
            yield _this24.writeFile(w_path, vue.full); //
        ...
        if (_this24.x_state.npm['gif.js']) {
          ...
          var static_path = path.join(_this24.x_state.dirs.static, 'gif.worker.js');
        ...
        if (Object.keys(_this24.x_state.assets).length > 0) {
          _this24.debug({
          ...
          for (var i in _this24.x_state.assets) {
            //@TODO add support for i18n assets
            var asset = _this24.x_state.assets[i];

            if (!asset.i18n) {
              var source = path.join(_this24.x_state.dirs.base, asset.original);
              var target = path.join(_this24.x_state.dirs.assets, asset.original.split('/').slice(-1)[0]); //this.debug({ message: `Copying asset`, data:{source,target}, color:'cyan'});
        ...
        if (!_this24.x_state.central_config.componente) {
          yield _this24.createVueXStores();
          yield _this24.createServerMethods();
          yield _this24.createMiddlewares(); //create server files (nuxt express, mimetypes)

          yield _this24.prepareServerFiles(); //declare required plugins

          yield _this24.installRequiredPlugins(); //create NuxtJS plugin definition files

          var nuxt_plugs = yield _this24.createNuxtPlugins(); //return plugin array list for nuxt.config.js

          _this24.x_state.nuxt_config.plugins = nuxt_plugs.nuxt_config;
          _this24.x_state.nuxt_config.css = nuxt_plugs.css_files; //create nuxt.config.js file

          yield _this24.createNuxtConfig(); //create package.json

          yield _this24.createPackageJSON(); //create VSCode helpers

          yield _this24.createVSCodeHelpers(); //create serverless.yml for deploy:sls - cfc:12881

          yield _this24.createServerlessYML(); //execute deploy (npm install, etc) - moved to onEnd
        }
      })();
    } // ************************
    ...
    _isLocalServerRunning() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = yield is_reachable(_this25.x_state.central_config.port);
        return resp;
      })();
    }
    /*
    ...
    _readModelos() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this26.debug('_readModelos');

        _this26.debug_time({
          id: 'readModelos'
        });

        var modelos = yield _this26.dsl_parser.getNodes({
          text: 'modelos',
          level: 2,
          icon: 'desktop_new',
          recurse: true
        ...
        var tmp = {
          appname: _this26.x_state.config_node.name
        },
            fields_map = {};
        var resp = {
          tables: {},
        ...
        if (modelos.length > 0) {
          ...
          for (var table of modelos[0].nodes) {
            ...
            yield _this26.setImmediatePromise(); //@improved
          }
        }
        ...
        if (resp.length > 0) {
          ...
          _this26.x_state.plugins['../../node_modules/alasql/dist/alasql.min.js'] = {
            global: true,
            npm: {
              alasql: '*'
            },
    ...
    _readAssets() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this27.debug('_readAssets');

        _this27.debug_time({
          id: '_readAssets'
        });

        var assets = yield _this27.dsl_parser.getNodes({
          text: 'assets',
          level: 2,
          icon: 'desktop_new',
          recurse: true
    ...
    _readCentralConfig() {
      ...
      return _asyncToGenerator(function* () {
        _this28.debug('_readCentralConfig');

        var central = yield _this28.dsl_parser.getNodes({
          level: 1,
          recurse: false
        ...
        if (!resp[':cache']) _this28.x_config.cache = false; // disables cache when processing nodes (@todo)
        // return
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = {
          ...
          secrets: {}
            ...
            config_node = {};
        var search = yield _this29.dsl_parser.getNodes({
          text: 'config',
          level: 2,
          icon: 'desktop_new',
          recurse: true
            ...
            if (key.text.toLowerCase() == 'meta') {
              for (var meta_child of key.nodes) {
                ...
                if (meta_child.text.toLowerCase() == 'keywords') {
                  ...
                  resp.meta.push({
                    hid: yield _this29.hash(meta_child.nodes[0].text),
                    name: 'keywords',
        ...
        if (!resp.name) {
          ...
          var dsl_folder = path.dirname(path.resolve(_this29.x_flags.dsl));
          var parent_folder = path.resolve(dsl_folder, '../');
          var folder = dsl_folder.replace(parent_folder, '');
          resp.name = folder.replace('/', '').replace('\\', '') + '_' + path.basename(_this29.x_flags.dsl, '.dsl'); //console.log('folder:',{folder,name:resp.name});
          //this.x_flags.dsl
    ...
    getParentNodes() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : _this30.throwIfMissing('id');
        var exec = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : false;
        var parents = yield _this30.dsl_parser.getParentNodesIDs({
          id,
          array: true
        });
        var resp = [];
        ...
        for (var parent_id of parents) {
          var node = yield _this30.dsl_parser.getNode({
            id: parent_id,
            recurse: false
          });
          var command = yield _this30.findValidCommand({
            node,
            object: exec
          });
    ...
    jsDump(obj) {
      ...
      var escape = function escape(obi) {
        ...
        } else if (typeof ob === 'string' && (ob.charAt(0) == '!' || ob.indexOf('this.') != -1 || ob.indexOf('new ') != -1 || ob.indexOf("'") != -1 || ob.indexOf('`') != -1 || ob.charAt(0) != '0' && isNumeric(ob) || ob == '0' || ob == 'true' || ob == 'false')) {
          nuevo += ob;
    ...
    hash(thing) {
      ...
      return _asyncToGenerator(function* () {
        var resp = yield _this31.dsl_parser.hash(thing);
