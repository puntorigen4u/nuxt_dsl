        ...
        'def_listado': {
          ...
          func: function () {
            var _func70 = _asyncToGenerator(function* (node, state) {
              ...
              var params = aliases2params('def_listado', node, true);
        ...
        'def_xcada_registro': {
          ...
          func: function () {
            var _func95 = _asyncToGenerator(function* (node, state) {
              ...
              if (params.unique == 0) params.unique = params.use_index; //code
              ...
              if (state.from_script) {
                ...
                if (!params[':each'] && node.nodes_raw.length > 0) {
                  var child_nodes = node.getNodes();

                  for (var x of child_nodes) {
