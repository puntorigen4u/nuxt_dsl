      ...
      return _asyncToGenerator(function* () {
        ...
        for (var thefile_num in processedNodes) {
          ...
          if (thefile.file.split('.').slice(-1) == 'omit') {
            ...
            console.log('@TODO pending support for "grouped" componentes'); //await this.processOmitFile(thefile);
            ...
            var vue = yield _this28.getBasicVue(thefile); // @TODO check the vue.template replacements (8-mar-21)
