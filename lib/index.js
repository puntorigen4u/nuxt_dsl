          ...
          func: function () {
            var _func43 = _asyncToGenerator(function* (node, state) {
              ...
              if ((yield context.hasParentID(node.id, 'def_toolbar')) == true && (yield context.hasParentID(node.id, 'def_slot')) == false) {
                resp.valid = false;
              } else if ((yield context.hasParentID(node.id, 'def_datatable_headers')) == true) {
                resp.valid = false;
        ...
        'def_tooltip': {
          ...
          func: function () {
            var _func60 = _asyncToGenerator(function* (node, state) {
              ...
              var params = aliases2params('def_tooltip', node);
              var tmp = {
                text: '',
                params_span: {}
              };
          ...
          func: function () {
            var _func67 = _asyncToGenerator(function* (node, state) {
              ...
              if (params.colores) {
                ...
                /*context.x_state.pages[state.current_page].variables[params[':gradient']] = params.colores.replaceAll('[','').replaceAll(']','').split(',');
                context.x_state.pages[state.current_page].var_types[params[':gradient']] = 'array';
                */
          ...
          func: function () {
            var _func73 = _asyncToGenerator(function* (node, state) {
              ...
              if (elements.operator == 'idioma es') {
                ...
                params.expresion = "".concat(elements.variable, "!=").concat(elements.value); // records
              ...
              var expresion_js = params.expresion.replaceAll('$variables.', 'this.').replaceAll('$vars.', 'this.').replaceAll('$params.', 'this.').replaceAll('$store.', 'this.$store.state.');
              var expresion_view = params.expresion.replaceAll('$variables.', '').replaceAll('$vars.', '').replaceAll('$params.', '').replaceAll('$store.', '$store.state.');
              resp.state.meta = {
                if_js: expresion_js,
