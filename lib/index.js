  ...
  class vue_dsl extends concepto {
    ...
    */
    ...
    _isLocalServerRunning() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = yield is_reachable(_this2.x_state.central_config.port);
        return resp;
      })();
    }
    /*
    ...
    */
    ...
    _readModelos() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this3.debug('_readModelos');

        _this3.debug_time({
          id: 'readModelos'
        });

        var modelos = yield _this3.dsl_parser.getNodes({
          text: 'modelos',
          level: 2,
          icon: 'desktop_new',
          recurse: true
        ...
        var tmp = {
          appname: _this3.x_state.config_node.name
        },
            fields_map = {};
        var resp = {
          tables: {},
        ...
        if (resp.length > 0) {
          ...
          _this3.x_state.plugins['../../node_modules/alasql/dist/alasql.min.js'] = {
            global: true,
            npm: {
              alasql: '*'
            },
    ...
    */
    ...
    _readAssets() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this4.debug('_readAssets');

        _this4.debug_time({
          id: '_readAssets'
        });

        var assets = yield _this4.dsl_parser.getNodes({
          text: 'assets',
          level: 2,
          icon: 'desktop_new',
          recurse: true
    ...
    */
    ...
    _readCentralConfig() {
      ...
      return _asyncToGenerator(function* () {
        _this5.debug('_readCentralConfig');

        var central = yield _this5.dsl_parser.getNodes({
          level: 1,
          recurse: false
        ...
        if (!resp[':cache']) _this5.x_config.cache = false; // disables cache when processing nodes (@todo)
        // return
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = {
          ...
          secrets: {}
            ...
            config_node = {};
        var search = yield _this6.dsl_parser.getNodes({
          text: 'config',
          level: '2',
          icon: 'desktop_new',
          recurse: true
            ...
            if (key.text.toLowerCase() == 'meta') {
              for (var meta_child of key.nodes) {
                ...
                if (meta_child.text.toLowerCase() == 'keywords') {
                  ...
                  resp.meta.push({
                    hid: _this6.hash(meta_child.nodes[0].text),
                    name: 'keywords',
        ...
        if (!resp.name) {
          ...
          resp.name = folder.replace('/', '').replace('\\', '') + '_' + path.basename(_this6.x_flags.dsl, '.dsl'); //console.log('folder:',{folder,name:resp.name});
          //this.x_flags.dsl
